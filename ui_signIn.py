...
"padding-bottom:7px;")
    ...
    def retranslateUi(self, SignIn):
        ...
        self.label_8.setText(QCoreApplication.translate("SignIn", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; font-style:italic;\">Anonymous</span></p><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; font-style:italic;\">Analytics</span></p></body></html>", None))
