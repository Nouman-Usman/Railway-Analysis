...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolBox_2.setItemText(self.toolBox_2.indexOf(self.page_5),
                                   QCoreApplication.translate("MainWindow", u"Main Menu", None))
        self.label_23.setText(
            QCoreApplication.translate("MainWindow", u"The application is developed by Nouman, Shahbaz and Khuram ",
                                       None))
